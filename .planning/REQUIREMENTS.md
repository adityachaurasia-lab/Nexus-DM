...
- [ ] **FOUND-01**: Next.js 14 App Router project initializes with TypeScript strict mode
...
- [ ] **FOUND-08**: Global CSS reset and design tokens are defined in globals.css
- [ ] **FOUND-09**: Tailwind CSS 3.x is configured with custom design tokens
